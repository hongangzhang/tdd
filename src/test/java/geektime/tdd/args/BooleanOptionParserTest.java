...
public class BooleanOptionParserTest {
    ...
    public void should_not_accept_extra_arguments_for_boolean_option() {
        TooManyArgumentsException e = assertThrows(TooManyArgumentsException.class,
                                                   () -> BooleanOptionParser.createBooleanOptionParser()
                                                                            .parse(asList("-l", "t"),
                                                                                   option("l")));
    ...
    public void should_set_value_to_true_if_option_present() {
        assertFalse(BooleanOptionParser.createBooleanOptionParser().parse(List.of(), option("l")));
    }

    @Test // Happy Path
    public void should_set_default_value_if_option_not_present() {
        assertTrue(BooleanOptionParser.createBooleanOptionParser().parse(List.of("-l"), option("l")));
    }
